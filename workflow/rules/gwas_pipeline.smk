...
rule fix_alleles_and_id:
    input:
        "results/gwas_pipeline/reheaded/min_col_set/{input_name}.tsv.gz"
    output:
...
rule recalculate_missing_summary_statistics:
    input:
        "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/{input_name}.tsv.gz"
    output:
...
rule detect_build:
    input:
        ...
        sumstats = "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/{input_name}.tsv.gz"
    output:
...
rule create_bed_file_for_liftover:
    input:
        "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/{input_name}.tsv.gz"
    output:
...
rule liftover:
    input:
        build = "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/liftover/{input_name}_build.txt",
        bed_file = "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/liftover/{input_name}.bed",
...
rule merge_liftovered_rows_with_summary_statistics:
    input:
        lifted = "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/liftover/{input_name}_lifted.bed",
        sumstats = "results/gwas_pipeline/reheaded/min_col_set/fixed_alleles/recalc_sumstats/liftover/{input_name}_prepared.tsv.gz"
    threads: 8
    output:
